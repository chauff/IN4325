...
- **core IR**: during weeks 3.2 to 3.5 between 9am and 11:30am at least two staff members will be available to help groups with their IR project (maybe more, depending on the need). You can sign up for 15 minute timeslots here: https://doodle.com/poll/646g8ws5vy3d7bfc (two slots are available per option, so do not register twice).
